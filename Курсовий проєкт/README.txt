...
2. Запустіть клієнтів: кожен клієнт запускається окремо з передачею свого імені та 
   імені співрозмовника:
           python client_ChaCha_Poly_DH.py Alice Bob
           python client_ChaCha_Poly_DH.py Bob Alice
...
secure_messenger/
│
├── server_ChaCha_Poly_DH.py    # Код сервера
├── client_ChaCha_Poly_DH.py    # Код клієнта
├── logs/
