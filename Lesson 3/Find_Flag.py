...
#   Пояснення коду:
# •	pad_text: заповнює початок блоку так, щоб FLAG завжди був на одній позиції у 16-байтовому блоці
# •	get_encrypted_data: відправляє контрольований запит до сервера та отримує зашифровані дані
# •	trial_text: для кожного символу додає новий байт до FLAG та перевіряє, чи збігається зашифрований блок
